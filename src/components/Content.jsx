...
const Content = () => {
  ...
  return (
    <section className="md:flex">
      <div className="ml-[70px] mr-[54px] text-bold shadow-md rounded-[24px] flex flex-col items-center bg-gradient-to-b from-white/40 to-transparent md:w-[25%]">
      ...
      <div className="text-13 flex flex-col w-[100%] mt-[90px] font-semibold md:w-[30%] md:mt-0 md:text-16 md:ml-[15%]">
